...
perEachTestConfig(({ outputDTsFiles, outputFile }) => {
    describe(`Type Definitions Tests (using output **/*/${outputFile} files)`, () => {
        describe('Structured Output Tests', () => {
            let astw

            before(async () => {
                configuration.outputDTsFiles = outputDTsFiles
                astw = (await prepareUnitTest('type/model.cds', locations.testOutput('type_test'))).astw
            })
        ...
        describe('Flat Output Tests', () => {
            ...
            before(async () => {
                configuration.outputDTsFiles = outputDTsFiles
                astw = (await prepareUnitTest('type/model.cds', locations.testOutput('type_test'), { typerOptions: { inlineDeclarations: 'flat' } })).astw
            })
        ...
        describe('Branded Primitives', () => {
            ...
            before(async () => {
                configuration.outputDTsFiles = outputDTsFiles
                astw = (await prepareUnitTest('type/model.cds', locations.testOutput('type_test'), { typerOptions: { brandedPrimitiveTypes: true } })).astw
            })
