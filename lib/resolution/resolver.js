...
class Resolver {
    ...
    // /**
    //  * @param {string} fq - the full qualifier of an entity
    //  * @param {string} namespace - the namespace therein
    //  */
    // #cacheNamespace (fq, namespace) {
    //     this.#caches.namespaces[fq] = namespace
    // }
    ...
    //  * @returns {string[]?}
    //  */
    // #getCachedPropertyAccess (fq) {
    //     return this.#caches.propertyAccesses[fq]
    // }

    // /**
    //  * @param {string} fq - the full qualifier of an entity
    //  * @param {string[]} propertyAccess - the property access path to cache
    //  */
    // #cachePropertyAccess (fq, propertyAccess) {
    //     this.#caches.propertyAccesses[fq] = propertyAccess
    // }
     ...
     * @returns {boolean} true, iff the entity exists in the CSN
     */
    existsInCsn(fq) {
