 ...
 * @param {EntityInfo} info
 * @param {string} name
 * @param {import('../file').Path | undefined} relative
 * @returns {string}
 */
...
/**
 * Checks whether a candidate name collides with any ancestor's class name.
 ...
 * @param {EntityInfo[]} ancestorInfos - resolved ancestor infos
...
function hasAncestralNamingCollision (ancestorInfos, clean) {
    return ancestorInfos.some(ancestor => {
