...
const isViewOrProjection = entity => entity.query || entity.projection
...
/**
 * @param {import("./visitor").EntityCSN} entity - the entity
 */
...
/**
 * @param {import("./visitor").EntityCSN | undefined} entity - the entity
 ...
 * @param {import("./visitor").EntityCSN} element - csn of entity to retrieve cardinality for
