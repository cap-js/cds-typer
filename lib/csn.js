 ...
 * @param {EntityCSN} [entity] - the entity
 */
const isStructuredType = entity => isType(entity) && !!entity?.elements
...
/**
 * @param {any} thing - the entity
 * @returns {thing is import("./typedefs").resolver.ref}
 */
const isRef = thing => typeof thing === 'object' && Object.hasOwn(thing, 'ref')

/**
 * @param {any} thing - the entity
 * @returns {thing is { elements: any }}
 */
const hasElements = thing => typeof thing === 'object' && Object.hasOwn(thing, 'elements')
