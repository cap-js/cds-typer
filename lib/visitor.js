...
const { isView, isUnresolved, propagateForeignKeys, collectDraftEnabledEntities, isDraftEnabled, isType, isProjection, getMaxCardinality, isViewOrProjection, isEnum, isEntity, lookUpRefType } = require('./csn')
            ...
            buffer.addIndentedBlock(`return class ${clean} extends ${ancestorsAspects} {`, () => {
                ...
                for (const e of enums) {
                    ...
                    if (typeof e?.type !== 'string' && e?.type?.ref) {
                        e.resolvedType = /** @type {string} */(lookUpRefType(this.csn.inferred, e.type.ref)?.type)
                    }
