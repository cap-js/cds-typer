...
const { amendCSN, isView, isUnresolved, propagateForeignKeys, isDraftEnabled, isType, isProjection, getProjectionTarget, getProjectionRenames, getViewTarget } = require('./csn')
