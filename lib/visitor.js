...
const { EntityRepository, asAspectFnIdentifier, hasAncestralNamingCollision } = require('./resolution/entity')
...
class Visitor {
    ...
    #aspectify(fq, entity, buffer, options = {}) {
        ...
        for (const e of enums) {
            ...
            file.addInlineEnum({ entityCleanName: clean, entityFqName: fq, propertyName: normalizedPropertyName, kvs: csnToEnumPairs(e, {unwrapVals: true}), buffer: staticMembersBuffer, doc: eDoc, skipTsDeclaration: !!enumImportPrefix })
        }
        if ('kind' in entity) {
