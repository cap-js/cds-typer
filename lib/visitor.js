...
class Visitor {
    ...
    #aspectify(fq, entity, buffer, options = {}) {
        ...
        for (const e of enums) {
            ...
            const enumName = propertyToInlineEnumName(enumClean, normalizedPropertyName)
            ...
            file.addInlineEnum(clean, fq, normalizedPropertyName, csnToEnumPairs(e, {unwrapVals: true}), staticMembersBuffer, eDoc)
        }
        if ('kind' in entity) {
