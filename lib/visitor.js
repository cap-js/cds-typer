...
const { File, SourceFile, baseDefinitions, Buffer } = require('./file')
const { FlatInlineDeclarationResolver, StructuredInlineDeclarationResolver } = require('./components/inline')
const { CSN, Resolver } = require('./components/resolver')
 ...
 * @property {string} [jsConfigPath]
 */

 /**
  * @typedef {Object} VisitorOptions
  * @property {boolean} propertiesOptionsl - true -> all properties are generated as optional ?:. (standard CAP behaviour, where properties be unavailable)
  * @property {'flat' | 'structured'} inlineDeclarations  - 'structured'` -> @see inline.StructuredInlineDeclarationResolver, 'flat'` -> @see inline.FlatInlineDeclarationResolver
  */ 
