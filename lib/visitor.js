...
const { EntityRepository, asAspectFnIdentifier, asClassIdentifier, hasAncestralNamingCollision } = require('./resolution/entity')
...
class Visitor {
    ...
    #aspectify(fq, entity, buffer, options = {}) {
        ...
        this.#printStaticKeys(keysElementsActionsBuffer, clean, ancestorInfos, file)
        this.#printStaticElements(keysElementsActionsBuffer, clean)
        this.#printStaticActions(entity, clean, keysElementsActionsBuffer, ancestorInfos, file)
