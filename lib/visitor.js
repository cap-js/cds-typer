...
const { SourceFile, baseDefinitions, Buffer, Path } = require('./file')
...
class FileRepository {
    ...
    getNamespaceFile(path) {
        const key = path instanceof Path ? path.asIdentifier() : path
...
class Visitor {
    ...
    constructor(csn, options = {}, logger = new Logger()) {
        ...
        this.fileRepository.add(baseDefinitions.path.asIdentifier(), baseDefinitions)
