...
const { docify, createPromiseOf } = require('./components/wrappers')
...
class Visitor {
    ...
    #printOperation(fq, operation, kind) {
        ...
        // results of operations are effectively a Promise at runtime
        returns = operation.returns ? createPromiseOf(returns) : returns
