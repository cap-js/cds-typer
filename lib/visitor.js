...
class Visitor {
    ...
    #aspectify(fq, entity, buffer, options = {}) {
        ...
        // CLASS ASPECT
        buffer.addIndentedBlock(this.tsPrinter.printAspectFunction({
            aspectFunctionName,
            ...
            for (const e of enums) {
                ...
                file.addInlineEnum(clean, fq, normalizedPropertyName, csnToEnumPairs(e, {unwrapVals: true}), memberBuffer, eDoc)
            }
            ...
            buffer.addIndentedBlock(this.tsPrinter.printAspect({
                clean,
