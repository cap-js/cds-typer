            ...
            .concat(
                ...
                .concat(this.inflections
                    ...
                    .flatMap(([singular, plural, original]) => Array.from(new Set([
                        `module.exports.${singular} = { is_singular: true, __proto__: csn.${original} }`, // csn.${original}`,
                        /Array<.*>/.test(plural) ? undefined : `module.exports.${plural} = { is_plural: true, __proto__: csn.${original} }`, // `module.exports.${plural} = csn.${original}`,
