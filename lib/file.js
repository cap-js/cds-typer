...
class SourceFile extends File {
     ...
     * @param {string} [options.returns='any'] - the return type of the function
     * @param {'action' | 'function'} options.kind - kind of the lambda
     * @param {string} [options.initialiser] - the initialiser expression
     * @param {boolean} [options.isStatic=false] - whether the lambda is static
     * @param {{name: string, parameters: [string, string][], returns: string, initialiser: string}} options.parameters - name, parameters, return type, and initialiser expression
