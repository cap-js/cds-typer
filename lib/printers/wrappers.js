 ...
 * @returns {string}
 */
const draftOf = t => `${base}.DraftOf<${t}>`
 ...
 * @returns {string}
 */
const draftsOf = t => `${base}.DraftsOf<${t}>`
 ...
 * @returns {string}
 */
const elementsOf = t => `${base}.ElementsOf<${t}>`
 ...
 * @returns {string}
 */
const toOneAssociation = t => `${base}.Association.to<${t}>`
 ...
 * @returns {string}
 */
const toManyAssociation = t => `${base}.Association.to.many<${t}>`
 ...
 * @returns {string}
 */
const compositionOfOne = t => `${base}.Composition.of<${t}>`
 ...
 * @returns {string}
 */
const compositionOfMany = t => `${base}.Composition.of.many<${t}>`
 ...
 * @returns {string}
 */
const unionOf = (...types) => types.join(' | ')
 ...
 * @returns {string}
 */
const intersectionOf = (...types) => types.join(' & ')
 ...
 * ```
 */
const promiseOf = t => `globalThis.Promise<${t}>`

/**
 * Creates a branded type.
 * @param {string} t - the type to brand.
 */
const brandedType = t => `{ __brand: '${t}' }`
