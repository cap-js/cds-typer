...
class EntityRepository {
     ...
     */
    getByFq (fq) {
        if (!Object.hasOwn(this.#cache, fq)) {
            this.#cache[fq] = new EntityInfo(fq, this.#resolver)
        }
...
class EntityInfo {
     ...
     * @param {Resolver} resolver
     */
    constructor (fullyQualifiedName, resolver) {
        const untangled = resolver(fullyQualifiedName)
        this.#resolver = resolver
