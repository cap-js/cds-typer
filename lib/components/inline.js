...
class InlineDeclarationResolver {
    ...
    resolveInlineDeclaration(items, into, relativeTo) {
        ...
        for (const [subname, subelement] of Object.entries(items ?? {})) {
            ...
            // so we can probably get rid of this distinction and male #resolveTypeName private again
     ...
     * @param {TypeResolveInfo_ & { inflection?: Inflection }} type - type of the property
